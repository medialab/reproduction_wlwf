...
STOP_WORDS_FR = ['', "'d", "'ll", "'m", "'re", "'s", "'ve", '-', '0', '1', '2', '3', 
                 ...
                 "c'était", 'ca', 'ce', 'cela', 'celle', 'celui', 'ces', 'cest', 
                 'cet', 'cetait', 'cette', 'ceux', 'chaque', 'chez', 'co', 'comme', 
                 'comment', 'compte', 'contre', 'coup', 'cours', 'crois', 'cétait', 
                 'c’est', 'd', 'dans', 'de', 'deja', 'depuis', 'des', 'detre', 'deux', 
                 'dire', 'dis', 'dit', 'dm', 'dois', 'doit', 'donc', 'du', 'déjà', 
                 'dêtre', 'e', 'eh', 'elle', 'elles', 'en', 'encore', 'entre', 
                 ...
                 'hein', 'https', 'i', 'il', 'ils', 'it', 'j', "j'", "j'ai", "j'aime", 
                 "j'avais", "j'me", "j'suis", "j'vais", 'jai', 'jaime', 'jamais', 
                 'javais', 'je', 'jen', 'jetais', 'jme', 'jour', 'journee', 'journée', 
                 'jsp', 'jsuis', 'jte', 'juste', 'jvais', 'jveux', 'jétais', 'j’ai', 
                 'k', 'l', 'la', 'le', 'les', 'leur', 'leurs', 'll', 'lol', 'lui', 'là', 
                 'm', 'ma', 'maintenant', 'mais', 'mal', 'mdr', 'mdrr', 'mdrrr', 
                 'mdrrrr', 'me', 'mec', 'meme', 'merci', 'merde', 'mes', 'met', 
                 'mettre', 'mieux', 'mis', 'mm', 'moi', 'moins', 'moment', 'mon', 
                 'monde', 'mtn', 'même', 'n', 'na', 'nan', 'ne', 'nest', 'ni', 'nn', 
                 'non', 'nos', 'notre', 'nous', 'o', 'of', 'oh', 'ok', 'on', 'ont', 
                 'ou', 'ouais', 'oui', 'où', 'p', 'par', 'parce', 'parle', 'pas', 
                 'passe', 'pcq', 'pense', 'personne', 'peu', 'peut', 'peutetre', 
                 'peutêtre', 'peux', 'plus', 'pour', 'pourquoi', 'pq', 'pr', 'prend', 
                 'prendre', 'prends', 'pris', 'ptdr', 'ptdrrr', 'ptn', 'pu', 'putain', 
                 'q', 'qd', 'qu', "qu'", "qu'il", "qu'on", 'quand', 'que', 'quel', 
                 'quelle', 'quelque', 'quelques', 'quelquun', 'qui', 'quil', 'quils', 
                 'quoi', 'quon', 'r', 're', 'rien', 'rt', 's', 'sa', 'sais', 'sait', 'sans', 
                 'se', 'sera', 'ses', 'sest', 'si', 'sil', 'soir', 'soit', 'son', 
                 'sont', 'suis', 'super', 'sur', 't', 'ta', 'tas', 'te', 'tellement', 
                 'temps', 'tes', 'tete', 'the', 'tjrs', 'tjs', 'toi', 'ton', 
                 'toujours', 'tous', 'tout', 'toute', 'toutes', 'tres', 'trop', 
                 'trouve', 'trouvé', 'très', 'tt', 'tu', 'tête', 'u', 'un', 'une', 
                 'v', 'va', 'vais', 'vas', 've', 'veut', 'veux', 'via', 'vie', 'viens', 
                 'voila', 'voilà', 'voir', 'vois', 'voit', 'vont', 'vos', 'votre', 
                 'vous', 'vrai', 'vraiment', 'vs', 'vu', 'w', 'wsh', 'x', 'xd', 'y', 'ya', 
                 'z', 'à', 'ça', 'ça', 'étais', 'était', 'été', 'êtes', 'être', '–—']
