...
# for BERTOPIC ----
rs <- read_csv("data_prod/dashboard/bertopic/reduced/representative_docs_congress.csv")
...
save(rep_docs_media, file="data_prod/dashboard/bertopic/reduced/representative_docs_media.rdata")
#
